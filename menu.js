  ...
  projectBtn.forEach((bt) => {
    bt.addEventListener('click', () => {
      ...
      modal.innerHTML = `
       ...
       <div class="modal-img">
          <img src="${projects[j].cardImage}" alt="language details" />
       </div>
    ...
    .map((k) => `<li> <a href="#">${k}</a></li>`).join('')}
      ...
      <div class="modal-anchor">
        <a href="#" class="modal-href"> See Live<img class="modal-href-pic" src="img/see-live.png" alt=" see live icon" /></a>
        <a href="#"class="modal-href"> See Source<img  class="modal-href-pic" src="img/see-source.png" alt=" see live icon" /></a>
      </div>
            `;
