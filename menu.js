...
const projects = [{
  id: '1',
  name: ' Wedding App ',
  homeImage: 'img/weddingH.png',
  cardImage: 'img/weddingM.png',
  desktopImage: 'img/weddingD.png',
  closeIcon: 'img/close-icon.png',
  description: 'Wedding App ',
  technologies: ['CSS', 'Bootstrap', 'reactJS'],
  modalInfo: 'The Wedding app is a magical digital companion that turns the journey to your big day into a seamless, joy-filled adventure. With its elegant design and user-friendly features, it is like having your own personal wedding planner right in your pocket.',
  liveText: 'See Live',
  seeIcon: '',
  sourceText: 'See Source',
  sourceIcon: '',
  liveLink: 'http://rosyj.netlify.app/',
  sourceLink: 'https://github.com/Donmark2k/wedding',
},
{
  id: '2',
  name: ' MicroGigs',
  homeImage: 'img/microgigsM.png',
  cardImage: 'img/microgigsH.png',
  desktopImage: 'img/microgigsD.png',
  closeIcon: 'img/close-icon.png',
  description: 'MicroGigs ',
  technologies: ['TailwindCSS', 'PHP', 'Laravel', 'MySQL'],
  modalInfo: 'MicroGigs, the epitome of modern job application platforms, is here to make your career journey sweeter than ever. With a touch of professionalism and a whole lot of heart, we have designed a platform that caters to your unique talents and aspirations.  At MicroGigs, we are all about matching your skills with the perfect opportunities. Our user-friendly interface makes it a breeze to browse through a myriad of job listings and connect with companies that share your passion. ',
  liveText: 'See Live',
  seeIcon: '',
  sourceText: 'See Source',
  sourceIcon: '',
  liveLink: 'https://microgig.up.railway.app/',
  sourceLink: 'https://github.com/Donmark2k/microgigs',
},
{
  id: '3',
  name: ' Baby Match ',
  homeImage: 'img/childM.png',
  cardImage: 'img/childH.png',
  desktopImage: 'img/childD.png',
  closeIcon: 'img/close-icon.png',
  description: 'Baby Match',
  technologies: ['CSS', 'HTML', 'Javascript'],
  modalInfo: 'This app allows couples to explore and understand the factors that influence the gender of their future child, all in a fun and informative way. It is like having a personal fertility mentor in your pocket, ready to assist you in making your dreams of family a reality. From tracking your menstrual cycle to identifying the optimal times for conception, Baby Match provides insights and knowledge for couples to make informed decisions',
  liveText: 'See Live',
  seeIcon: '',
  sourceText: 'See Source',
  sourceIcon: '',
  liveLink: 'https://childsp.netlify.app/',
  sourceLink: '',
},
{
  id: '4',
...
const technology = [
  {
    id: '1',
    name: ' JavaScript',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/javaScript.png?raw=true',
  },
  {
    id: '2',
    name: ' Bootstrap',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/bootstrap.png?raw=true',
  },
  {
    id: '3',
    name: ' CSS',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/css.png?raw=true',
  },
  {
    id: '4',
    name: ' React',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/react.png?raw=true',
  },
  {
    id: '5',
    name: ' Redux',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/redux.png?raw=true',
  },
  {
    id: '6',
    name: ' webpack',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/webpack.png?raw=true',
  }, {
    id: '7',
    name: ' Ruby',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/ruby.png?raw=true',
  },
  {
    id: '8',
    name: ' Rail',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/rail.png?raw=true',
  },
  {
    id: '9',
    name: ' Vite',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/vite.png?raw=true',
  },
  {
    id: '10',
    name: ' Postman',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/postman.png?raw=true',
  },
  {
    id: '11',
    name: ' Gitflow',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/gitflow.png?raw=true',
  },
  {
    id: '12',
    name: ' Kanban',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/kanban.png?raw=true',
  },
  {
    id: '13',
    name: ' Jest',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/jest.png?raw=true',
  },
  {
    id: '14',
    name: ' HTML',
    image: 'https://github.com/Donmark2k/My_portfolio/blob/main/icon/html.png?raw=true',
  },
];
